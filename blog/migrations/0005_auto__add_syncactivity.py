...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SyncActivity'
        db.create_table(u'blog_syncactivity', (
        ...
        db.send_create_signal(u'blog', ['SyncActivity'])


    def backwards(self, orm):
        # Deleting model 'SyncActivity'
        db.delete_table(u'blog_syncactivity')
    ...
    models = {
        ...
        u'blog.post': {
            ...
            'content_format': ('django.db.models.fields.CharField', [], {'max_length': "'30'"}),
            'content_html': ('django.db.models.fields.TextField', [], {'default': "''"}),
        ...
        u'blog.version': {
            ...
            'edit_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'entry': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['blog.Post']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
